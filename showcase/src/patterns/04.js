...
const Usage = () => {
  ...
  return(
    ...
    <MediumClap onClap={handleClap} style ={{ border: '2px solid red'}}>
      <MediumClap.icon />
      <MediumClap.Count />
      <MediumClap.Total style={{background: 'yellow', color: 'red'}} />
    </MediumClap>
